...
See [[openSUSE/packages#VSCode]].

## Docker

For usage, see [[Linux/Docker]].

1. Add *Virtualization:containers* repository. See [[openSUSE/packages#Container]].
...
See [[openSUSE/packages#NVIDIA Container Toolkit]].
...
1. Add *Emulators* repository. See [[openSUSE/packages#Emulators]].
...
2. Install NVIDIA Container Toolkit. See [[openSUSE/packages#NVIDIA Container Toolkit]].
...
[openSUSE/packages#VSCode]: packages.md "openSUSE Package Management"
[Linux/Docker]: ../Docker.md "Docker Usage"
[openSUSE/packages#Container]: packages.md "openSUSE Package Management"
[openSUSE/packages#NVIDIA Container Toolkit]: packages.md "openSUSE Package Management"
[linux/KVM]: ../KVM.md "Kernel-based Virtual Machine Usage"
[bochs]: ../bochs.md "bochs Usage"
[openSUSE/packages#Emulators]: packages.md "openSUSE Package Management"
