...
Note that after this, *YaST Software* may automatically select some NVidia drivers to install. Do **not** install them because they will cause problems. See [[tweak#Graphics]].
...
[tweak#Graphics]: tweak.md "Tweak openSUSE Tumbleweed"
