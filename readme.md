...
After setting up the repository, head to [getting started](./doc-foam/getting-started.md) to get familiar with your new knowledge base!
...
- [getting-started](./doc-foam/getting-started.md) - learn how to use your Foam workspace
