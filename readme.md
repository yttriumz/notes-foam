...
After setting up the repository, head to [getting started](./foam_doc/getting-started.md) to get familiar with your new knowledge base!
...
- [getting-started](./foam_doc/getting-started.md) - learn how to use your Foam workspace
