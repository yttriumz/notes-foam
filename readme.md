...
After setting up the repository, head to [getting started](./docs-foam/getting-started.md) to get familiar with your new knowledge base!
...
- [getting-started](./docs-foam/getting-started.md) - learn how to use your Foam workspace
